...
resource serviceBusAccountRoleAssignment 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  name: guid(namespace.id, userAssignedIdentityPrincipalId, 'Azure Service Bus Data Owner')
  scope: namespace
  properties: {
