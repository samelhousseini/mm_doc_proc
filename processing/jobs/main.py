...
# Azure OpenAI Configuration - Unified approach
...
AZURE_OPENAI_MODEL_41 = os.getenv("AZURE_OPENAI_MODEL_41", "gpt-4.1")
AZURE_OPENAI_MODEL_4O = os.getenv("AZURE_OPENAI_MODEL_4O", "gpt-4o")  # corrected default
AZURE_OPENAI_MODEL_O3 = os.getenv("AZURE_OPENAI_MODEL_O3", "o3")
AZURE_OPENAI_MODEL_O3_MINI = os.getenv("AZURE_OPENAI_MODEL_O3_MINI", "o3-mini")
AZURE_OPENAI_MODEL_O4_MINI = os.getenv("AZURE_OPENAI_MODEL_O4_MINI", "o4-mini")
AZURE_OPENAI_MODEL_O1 = os.getenv("AZURE_OPENAI_MODEL_O1", "o1")
AZURE_OPENAI_MODEL_O1_MINI = os.getenv("AZURE_OPENAI_MODEL_O1_MINI", "o1-mini")
...
if debug_prints:
  ...
  # Print unified OpenAI configuration variables
  ...
  print(f"AZURE_OPENAI_MODEL_O3_MINI: {AZURE_OPENAI_MODEL_O3_MINI}")
  print(f"AZURE_OPENAI_MODEL_O1: {AZURE_OPENAI_MODEL_O1}")
  print(f"AZURE_OPENAI_MODEL_O1_MINI: {AZURE_OPENAI_MODEL_O1_MINI}")
